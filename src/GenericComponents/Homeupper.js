  ...
  return (
    ...
    <div className="main-Container">
        ...
        <Link to={"/Hollywood"} >  
            ...
            <img src="https://content.api.news/v3/images/bin/3cf9bf4f8184eec397559f00f0a2c572?width=650" alt="not Found" height={"515px"} width={"100%"} />
        </Link>
        </div>
        ...
        <div className="contanier-right">
            ...
            <div className="item">
                ...
                <div className="title-2">
                    ...
                    <img src="https://ichef.bbci.co.uk/news/820/cpsprodpb/DAC3/production/_130630065_gettyimages-1267327926.jpg" alt="not found" height={"250px"} width={"100%"}/>
                </Link>
            </div>
